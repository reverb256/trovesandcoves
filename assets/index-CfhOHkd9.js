...
function bo(e, n, t, r) {
  if (Dr) {
    var l = ao(e, n, t, r);
    if (l === null) (Ml(e, n, r, jr, t), Yu(e, r));
...
function Li(e, n, t, r, l) {
  ...
  if ((Gn(n, l), n.stateNode === null))
    (_r(e, n), Na(n, t, r), xo(n, t, r, l), (r = !0));
  else if (e === null) {
    var u = n.stateNode,
      i = n.memoizedProps;
    u.props = i;
...
ys = _u;
gs = Ln;
var zd = { usingClientEntryPoint: !1, Events: [Zt, Un, ll, hs, vs, _u] },
  vt = {
...
const Rd = () =>
    te.jsx('section', {
      className:
        'min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-100 via-primary-300 to-primary-500',
      children: te.jsxs('div', {
        className:
          'bg-surface-100/80 shadow-2xl rounded-3xl border border-outline-variant p-10 max-w-xl w-full flex flex-col items-center gap-6',
        children: [
          te.jsx('h1', {
            className:
              'text-5xl font-display font-extrabold text-primary-900 mb-2 tracking-tight',
            children: 'Material You Hero',
          }),
          te.jsx('p', {
            className: 'text-lg text-on-surface-variant mb-4 text-center',
            children:
          ...
          te.jsx('button', {
            className:
              'mt-2 px-8 py-3 rounded-full bg-primary-600 hover:bg-primary-700 text-white font-semibold shadow-lg transition-all duration-200',
      ...
      children: te.jsx('div', {
        ...
        children: [1, 2, 3].map(e =>
          te.jsxs(
            ...
            {
              className:
                'bg-surface-100 rounded-3xl border border-outline-variant shadow-xl p-8 flex flex-col items-center hover:shadow-2xl transition-all',
              children: [
                te.jsxs('h2', {
                ...
                te.jsx('p', {
                  ...
                  children: 'Material You inspired dashboard card.',
                }),
                te.jsx('button', {
                  className:
                    'mt-4 px-6 py-2 rounded-full bg-primary-600 hover:bg-primary-700 text-white font-medium shadow transition-all',
                  children: 'Action',
                }),
              ],
            },
...
function Md() {
  return te.jsxs('div', { children: [te.jsx(Rd, {}), te.jsx(Od, {})] });
}
Wl.createRoot(document.getElementById('root')).render(
  te.jsx(gc.StrictMode, { children: te.jsx(Md, {}) })
);

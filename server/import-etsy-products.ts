...
const EXAMPLE_ETSY_PRODUCTS = [
  {
    title:
      'Handmade Turquoise Necklace, Lapis Lazuli, Pink Pearl, Leaf Pendant',
    description:
      'Handmade turquoise necklace featuring lapis lazuli and pink pearl with a delicate leaf pendant. Crafted with intention to empower your energy.',
    price: '88.00',
    imageUrl:
      'https://i.etsystatic.com/44567123/r/il/abcdef1234/abcd_efghij56_klmn.jpg',
    category: 'Necklaces',
  ...
  },
  {
    ...
    description:
      'Luxurious handwrapped citrine and pearl necklace set. Heavy, genuine crystals crafted with intention to attract abundance and confidence.',
    price: '260.00',
    imageUrl:
      'https://i.etsystatic.com/44567123/r/il/abcdef1234/abcd_efghij56_klmn.jpg',
    category: 'Necklaces',
  ...
  {
    title:
      'Large Raw Citrine Necklace with Turquoise Accent | One of a Kind Gift',
    description:
      'One-of-a-kind raw citrine necklace with turquoise accent. A powerful piece for transformation and abundance.',
    price: '166.00',
    imageUrl:
      'https://i.etsystatic.com/44567123/r/il/abcdef1234/abcd_efghij56_klmn.jpg',
    category: 'Necklaces',
  ...
  {
    title:
      'Handmade Lapis Lazuli, Smoky Quartz, Jade & Lava Stone Crystal Necklace',
    description:
      'Grounding and protective necklace combining lapis lazuli, smoky quartz, jade, and lava stone crystals.',
    price: '108.00',
    imageUrl:
      'https://i.etsystatic.com/44567123/r/il/abcdef1234/abcd_efghij56_klmn.jpg',
    category: 'Necklaces',
  ...
  },
  {
    ...
    description:
      'Royal lapis lazuli wire wrapped necklace on brown leather. Enhances psychic abilities and provides spiritual protection.',
    price: '78.00',
    imageUrl:
      'https://i.etsystatic.com/44567123/r/il/abcdef1234/abcd_efghij56_klmn.jpg',
    category: 'Necklaces',
  ...
  },
  {
    ...
    description:
      'Beautiful rose quartz pendant wire wrapped on brown leather cord. Promotes self-love and emotional healing.',
    price: '80.00',
    imageUrl:
      'https://i.etsystatic.com/44567123/r/il/abcdef1234/abcd_efghij56_klmn.jpg',
    category: 'Necklaces',
  ...
  },
  {
    ...
    description:
      'Raw pyrite heart pendant on 14K gold plated chain. Reiki infused for wealth and good luck energy.',
    price: '111.00',
    imageUrl:
      'https://i.etsystatic.com/44567123/r/il/abcdef1234/abcd_efghij56_klmn.jpg',
    category: 'Necklaces',
  ...
  },
  {
    ...
    description:
      'Bold lapis lazuli necklace on brown leather cord. Perfect for men - enhances wisdom and truth.',
    price: '78.00',
    imageUrl:
      'https://i.etsystatic.com/44567123/r/il/abcdef1234/abcd_efghij56_klmn.jpg',
    category: 'Necklaces',
  ...
  },
  {
    ...
    description:
      'Powerful combination necklace with turquoise, lapis lazuli, pearls, and hematite. Supports social connections and spirit guide communication.',
    price: '88.00',
    imageUrl:
      'https://i.etsystatic.com/44567123/r/il/abcdef1234/abcd_efghij56_klmn.jpg',
    category: 'Necklaces',
...
function etsyProductToDbProduct(
  etsy: (typeof EXAMPLE_ETSY_PRODUCTS)[0],
  index: number
): Product {
  const categoryId = Object.keys(CATEGORY_MAP).find(cat =>
    etsy.category.includes(cat)
  );
...
async function generateSeedFile() {
  ...
  if (fs.existsSync(ETSY_PRODUCTS_FILE)) {
    ...
    const products = userData.map(
      (p: (typeof EXAMPLE_ETSY_PRODUCTS)[0], i: number) =>
        etsyProductToDbProduct(p, i)
    );
...
`;
    ...
    const products = EXAMPLE_ETSY_PRODUCTS.map((p, i) =>
      etsyProductToDbProduct(p, i)
    );

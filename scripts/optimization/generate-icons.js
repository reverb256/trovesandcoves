...
console.log(
  'Basic favicon.ico created. For production, please use a proper icon generator tool with your SVG.'
);
console.log(
  'You can use online tools like https://realfavicongenerator.net/ with the favicon.svg file.'
);

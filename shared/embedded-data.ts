...
export const EMBEDDED_CATEGORIES: Category[] = [
  {
    ...
    description:
      'Divine crystal necklaces channeling celestial energy through sacred gemstone alchemy. Each piece amplifies intention and manifestation while enhancing your unique presence.',
  ...
  },
  {
    ...
    description:
      'Sacred healing crystals selected for their energetic properties and spiritual significance. Each stone carries ancient wisdom and transformative power.',
  ...
  },
  {
    ...
    slug: 'wire-wrapped',
    description:
      'Hand-wrapped wire crystal jewelry crafted with mindful intention. Each piece combines raw crystal beauty with artistic wirework to create unique talismans.',
...
export const EMBEDDED_PRODUCTS: Product[] = [
  {
    ...
    description:
      'Sacred collection of divine crystal pendants featuring lepidolite for tranquility, obsidian for protection, and citrine for manifestation. Each stone is lovingly wire-wrapped with golden intention, creating powerful talismans for spiritual awakening.',
    price: '90.00',
    categoryId: 1,
    imageUrl: '/images/jewelry/lepidolite-necklace-1.png',
    imageUrls: [
    ...
    careInstructions:
      'Honor these sacred talismans with moonlight cleansing and sage blessing. Store in sacred space away from harsh energies.',
    isActive: true,
    isFeatured: true,
  ...
  },
  {
    ...
    description:
      'Luminous gold chain adorned with sacred crystal pendant, lovingly wire-wrapped to channel divine energy. This celestial piece features a delicate crystal suspended in golden embrace.',
    price: '70.00',
    categoryId: 1,
    imageUrl: '/images/jewelry/gold-chain-crystal-1.png',
    ...
    careInstructions:
      "Protect from water's harsh embrace - honor your divine vessel's sacred materials.",
    isActive: true,
    isFeatured: true,
  ...
  },
  {
    ...
    description:
      'Divine twin vessel set channeling abundant solar manifestation through sacred citrine alchemy! The ethereal choker embraces throat chakra consciousness with luminous pink pearls and protective hematite grounding.',
    price: '200.00',
    categoryId: 2,
    imageUrl: '/images/jewelry/citrine-necklace-set-1.png',
    imageUrls: [
    ...
    careInstructions:
      "Honor with gentle reverence. Protect from moisture's harsh energy.",
    isActive: true,
    isFeatured: true,
  ...
  },
  {
    ...
    description:
      'Sacred Lapis Lazuli vessel channeling ancient Egyptian royal consciousness through celestial blue depths. This divine talisman awakens third eye perception and psychic gifts. 15 inches of divine armor.',
    price: '40.00',
    categoryId: 3,
    ...
    careInstructions:
      "Protect from water's harsh energy and chemical disruption.",
    isActive: true,
    isFeatured: false,
  ...
  },
  {
    ...
    description:
      'Divine Rose Quartz talisman on sacred brown leather cord. Embrace the infinite loving vibrations of this ethereal piece featuring a raw Rose Quartz pendant blessed with healing light. 18 inches.',
    price: '40.00',
    categoryId: 3,
    imageUrl: '/images/jewelry/authentic-rose-quartz-1.png',
    imageUrls: ['/images/jewelry/authentic-rose-quartz-1.png'],
    sku: 'TC-ROS-001',
    stockQuantity: 1,
    weight: '22g',
    materials: ['Leather', 'Stone'],
    ...
    careInstructions:
      'Honor with gentle sacred touch. Shield from harsh chemical energies.',
    isActive: true,
    isFeatured: false,
  ...
  },
  {
    ...
    description:
      'Sacred masculine vessel channeling ancient pharaoh consciousness through divine Lapis Lazuli depths. This handcrafted talisman awakens inner king sovereignty. 26 inches of sacred masculine power.',
    price: '40.00',
    categoryId: 3,
    ...
    gemstones: ['Lapis Lazuli'],
    careInstructions:
      "Honor leather's sacred nature - protect from water's embrace.",
    isActive: true,
    isFeatured: false,
  ...
  },
  {
    ...
    description:
      'Sacred five-stone harmony vessel weaving celestial wisdom through divine gemstone alchemy. Lapis Lazuli awakens third eye consciousness while Smoky Quartz grounds protective earthen energy.',
    price: '80.00',
    categoryId: 2,
    ...
    careInstructions:
      'Sacred lava stone absorbs blessed essential oils for enhanced spiritual practice.',
    isActive: true,
    isFeatured: true,
  ...
  },
  {
    ...
    description:
      'Sacred oceanic symphony vessel weaving ancient turquoise protection with celestial lapis wisdom. Divine turquoise channels protective fortune while enhancing sacred communication. 21 inches of divine protection.',
    price: '70.00',
    categoryId: 1,
    ...
    careInstructions:
      "Shield from water's harsh energy. Honor pearls with gentle reverence.",
    isActive: true,
    isFeatured: true,
  ...
  },
  {
    ...
    description:
      'Sacred alchemical transformation vessel born from upcycled enamel flower consciousness into divine stationary pendant power. Peridot channels heart prosperity while citrine ignites solar confidence manifestation.',
    price: '80.00',
    categoryId: 1,
    ...
    careInstructions:
      "Shield from water's harsh embrace to honor sacred longevity.",
    isActive: true,
    isFeatured: true,
...
export function getEmbeddedProducts(
  categoryId?: number
): ProductWithCategory[] {
  ...
  return products.map(product => ({
    ...
    category: product.categoryId
      ? EMBEDDED_CATEGORIES.find(c => c.id === product.categoryId)
      : undefined,
  }));
}
...
export function getEmbeddedFeaturedProducts(): ProductWithCategory[] {
  return EMBEDDED_PRODUCTS.filter(p => p.isActive && p.isFeatured).map(
    product => ({
      ...product,
      category: product.categoryId
        ? EMBEDDED_CATEGORIES.find(c => c.id === product.categoryId)
...
export function searchEmbeddedProducts(query: string): ProductWithCategory[] {
  ...
  return EMBEDDED_PRODUCTS.filter(
    p =>
      p.isActive &&

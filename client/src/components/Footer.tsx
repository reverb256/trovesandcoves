...
export default function Footer() {
  ...
  return (
    <footer
      ...
      style={{
        borderColor: 'rgba(74, 191, 191, 0.15)',
    ...
    >
      <div
        ...
        style={{
          background:
            'linear-gradient(90deg, transparent, rgba(74, 191, 191, 0.5), transparent)',
        }}
      ></div>
      ...
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8 mb-12">
          <div>
            ...
            >
              Handcrafted crystal jewelry featuring 14k gold-filled wire and
              genuine gemstones. Each piece is thoughtfully designed and crafted
              in Winnipeg, Canada.
            </p>
        ...
        <div
          ...
          style={{ borderColor: 'rgba(225, 175, 47, 0.2)' }}
        >
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            >
              ...
              <Link
                href="/privacy-policy"
                className="hover:text-turquoise-bright transition-colors ml-1"
              >
                Privacy Policy
              </Link>
            </div>
          ...
          <div
            ...
            style={{ borderColor: 'rgba(225, 175, 47, 0.15)' }}
          >
            <a

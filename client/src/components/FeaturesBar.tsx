  ...
  return (
    <section
      ...
      style={{
        ...
        borderColor: 'hsla(var(--troves-turquoise),0.15)',
      }}
    >
      {/* Top border accent */}
      <div
        ...
        style={{
          background:
            'linear-gradient(90deg, transparent, hsla(174,85%,45%,0.4), transparent)',
        }}
      ></div>
              ...
              >
                <div className="relative">
                  ...
                  <div
                    ...
                    style={{
                      backgroundColor: 'hsla(174,85%,45%,0.2)',
                      filter: 'blur(8px)',
                    }}
                  ></div>
                  <Icon
      ...
      <div
        ...
        style={{
          background:
            'linear-gradient(90deg, transparent, hsla(43,95%,55%,0.3), transparent)',
        }}
      ></div>
    </section>
  );

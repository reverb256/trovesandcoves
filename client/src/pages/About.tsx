  ...
  return (
    ...
    >
      ...
      <section className="relative overflow-hidden py-24 md:py-32">
        <div className="absolute top-0 left-0 w-full h-0.5" style={{ background: 'linear-gradient(90deg, transparent, #e1af2f, transparent)' }} />
        ...
        <div className="relative container mx-auto px-4 text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-8 flex flex-col items-center justify-center gap-2">
            <span style={{ fontFamily: '"Libre Baskerville", serif', color: '#4abfbf', textTransform: 'uppercase', letterSpacing: '0.08em' }}>About</span>
            <span style={{ fontFamily: '"Alex Brush", cursive', color: '#e1af2f' }}>Troves & Coves</span>
          </h1>

          <div className="w-16 h-0.5 mx-auto mb-8" style={{ background: '#e1af2f' }} />

          <p className="text-xl md:text-2xl max-w-3xl mx-auto leading-relaxed mb-6" style={{ fontFamily: '"Montserrat", sans-serif', color: '#1f1f1f' }}>
            Handcrafted crystal jewelry, made in Winnipeg with care and intention.
          </p>

          <p className="text-base md:text-lg max-w-2xl mx-auto leading-relaxed" style={{ fontFamily: '"Montserrat", sans-serif', color: '#4a4a4a' }}>
      ...
      <div className="container mx-auto px-4 py-16 md:py-24">
        ...
        <section className="mb-24 md:mb-32">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-6" style={{ fontFamily: '"Libre Baskerville", serif', color: '#1f1f1f' }}>
              Our Story
            </h2>
            <div className="w-16 h-0.5 mx-auto mb-8" style={{ background: '#e1af2f' }} />
          </div>
          ...
          >
            <CardContent className="p-8 md:p-12">
              <div className="space-y-6 text-base md:text-lg leading-relaxed" style={{ fontFamily: '"Montserrat", sans-serif', color: '#4a4a4a' }}>
                <p>
        ...
        <section className="mb-24 md:mb-32">
          <div className="text-center mb-12">
            ...
            <div className="w-16 h-0.5 mx-auto mb-8" style={{ background: '#e1af2f' }} />
            <p className="text-base md:text-lg max-w-2xl mx-auto" style={{ fontFamily: '"Montserrat", sans-serif', color: '#4a4a4a' }}>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            >
              <CardContent className="p-8">
                ...
                <h3 className="text-xl font-bold mb-4" style={{ fontFamily: '"Libre Baskerville", serif', color: '#1f1f1f' }}>
                  14k Gold-Filled
                </h3>
                <p className="leading-relaxed" style={{ fontFamily: '"Montserrat", sans-serif', color: '#4a4a4a' }}>
            ...
            >
              <CardContent className="p-8">
                <div className="w-12 h-12 rounded-full flex items-center justify-center mb-6" style={{ backgroundColor: 'hsla(174, 70%, 63%, 0.15)' }}>
                  <Gem className="w-6 h-6" style={{ color: '#4abfbf' }} />
                </div>
                <h3 className="text-xl font-bold mb-4" style={{ fontFamily: '"Libre Baskerville", serif', color: '#1f1f1f' }}>
                  Genuine Crystals
                </h3>
              ...
              return (
                ...
                >
                  <CardContent className="p-6">
                    ...
                    <h3 className="text-lg font-bold mb-3" style={{ fontFamily: '"Libre Baskerville", serif', color: '#1f1f1f' }}>
                      {value.title}
                    </h3>
                    <p className="text-sm leading-relaxed" style={{ fontFamily: '"Montserrat", sans-serif', color: '#6a6a6a' }}>
                      {value.description}
                    </p>
                  </CardContent>
                </Card>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {process.map((item, index) => (
              <div key={index} className="text-center">
                <div className="text-5xl font-bold mb-4" style={{ fontFamily: '"Libre Baskerville", serif', color: '#e1af2f', opacity: 0.3 }}>
                  {item.step}
                </div>
                <h3 className="text-xl font-bold mb-3" style={{ fontFamily: '"Libre Baskerville", serif', color: '#1f1f1f' }}>
                  {item.title}
                </h3>
                <p className="text-sm leading-relaxed" style={{ fontFamily: '"Montserrat", sans-serif', color: '#6a6a6a' }}>
                  {item.description}
        ...
        <section className="mb-16">
          ...
          >
            <CardContent className="p-10 md:p-14 text-center">
              ...
              <p className="text-base md:text-lg mb-10 leading-relaxed" style={{ fontFamily: '"Montserrat", sans-serif', color: '#d0d0d0' }}>

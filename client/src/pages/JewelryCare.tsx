...
import { Droplets, Shield, Sparkles, Moon, Sun, Heart } from 'lucide-react';
...
const careQuestions = [
  {
    '@type': 'Question',
    name: 'Can I shower with my gold-plated crystal jewelry?',
    acceptedAnswer: {
      '@type': 'Answer',
      text: 'No, we recommend removing your gold-plated jewelry before showering or swimming. Water, soap, and chlorine can damage the gold plating over time. Pat dry completely if jewelry gets wet accidentally.',
    },
  },
  {
    '@type': 'Question',
    name: 'How often should I clean my crystal necklace?',
    acceptedAnswer: {
      '@type': 'Answer',
      text: 'Clean your crystal necklace gently after each wear with a soft, dry cloth to remove oils and moisture. For deeper cleaning, use a damp cloth with mild soap, then dry thoroughly. Avoid submerging in water.',
    },
  },
  {
    '@type': 'Question',
    name: 'Do crystals need to be cleansed energetically?',
    acceptedAnswer: {
      '@type': 'Answer',
      text: 'Crystals are believed to absorb energy from their environment. You can cleanse them by placing in moonlight overnight, passing through sage smoke, or setting an intention. This is optional and based on personal preference.',
    },
  },
];
...
export default function JewelleryCare() {
  ...
  return (
    <>
      ...
      <SEOHead
        path="/jewelry-care"
        title="Jewelry Care Guide | Crystal Jewelry Maintenance Tips"
        description="Learn how to care for your handcrafted crystal jewelry. Expert tips for cleaning gold-plated wire, crystal maintenance, and preserving your jewelry's beauty."
      />
      <WebsiteSchema />
      <OrganizationSchema />
      <LocalBusinessSchema />
      <FAQSchema questions={careQuestions} />
      <ArticleSchema
        title="Jewelry Care Guide: Crystal Jewelry Maintenance Tips"
        description="Complete guide to caring for handcrafted crystal jewelry with gold-plated wire. Learn proper cleaning techniques, storage methods, and professional care options."
      ...
      <div className="min-h-screen" style={{ background: 'hsl(var(--bg-primary))' }}>
        ...
        <section className="relative overflow-hidden py-24" style={{ background: 'linear-gradient(180deg, hsl(var(--bg-primary)) 0%, hsl(var(--bg-secondary)) 100%)' }}>
          ...
          <div className="relative chamber-container text-center">
            ...
            <p className="text-sm mt-4" style={{ fontFamily: '"Montserrat", sans-serif', color: 'hsl(var(--text-muted))' }}>
            ...
            <CardContent className="p-6">
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {crystalCare.map((item) => (
                  <div
                    key={item.crystal}
                    className="border border-ornate-frame-gold/10 rounded-lg p-4"
                    style={{ backgroundColor: 'rgba(250, 248, 243, 0.5)' }}
                  >

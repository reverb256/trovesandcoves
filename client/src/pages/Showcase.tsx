...
const HeroVersions = {
  earliest: {
    ...
    commit: '063c27d',
    description:
      'Full-screen background image with navy overlay. Classic luxury jewelry aesthetic.',
    hero: (
        ...
        <div className="relative container mx-auto px-4 z-20">
          <div className="max-w-3xl">
            ...
            <p className="text-lg md:text-xl text-gray-200 mb-8 leading-relaxed">
              Discover exquisite jewelry crafted with passion in the heart of
              Winnipeg.
            </p>
            <div className="flex gap-4">
              <Link
                to="/products"
                className="bg-yellow-600 hover:bg-yellow-700 text-white px-6 py-3 rounded-full transition-colors"
              >
                Explore Collections
              </Link>
            </div>
  ...
  framerMotion: {
    ...
    commit: 'b6f7af0',
    description:
      'Animated gradient background (blue to purple) with Framer Motion animations and floating crystals.',
    hero: (
      <section className="min-h-[60vh] flex items-center justify-center bg-gradient-to-r from-blue-500 to-purple-600 relative overflow-hidden">
        <div className="relative z-10 text-center text-white p-6 max-w-4xl mx-auto">
          ...
          <div className="flex gap-4 justify-center">
            <Link
              to="/products"
              className="bg-white text-purple-600 hover:bg-purple-50 px-6 py-3 rounded-full shadow-lg font-semibold"
            >
              Explore Collection
            </Link>
          </div>
  ...
  minimalist: {
    ...
    commit: '3b75f79',
    description:
      'Clean white/turquoise gradient with badge, feature pills, and extensive content layout.',
    hero: (
      <section
        className="relative flex items-center justify-center overflow-hidden py-16 min-h-[60vh]"
        style={{
          background:
            'linear-gradient(135deg, hsl(var(--bg-primary)) 0%, hsl(var(--bg-secondary)) 50%, hsl(var(--bg-tertiary)) 100%)',
        }}
      >
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          <div
            className="inline-flex items-center justify-center gap-2 px-6 py-2 mb-8 rounded-full shadow-sm text-sm"
            style={{
          ...
          >
            ...
            <span className="font-medium tracking-widest uppercase">
              Authentic Canadian Crystal Artistry
            </span>
          </div>
          <h1
            className="text-5xl md:text-7xl font-serif font-bold mb-4"
            style={{ color: 'hsl(var(--accent-medium))' }}
          >
            Troves{' '}
            <span
              className="mx-2"
              style={{
                background:
                  'linear-gradient(90deg, hsl(var(--accent-vibrant)) 0%, hsl(var(--gold-vibrant)) 100%)',
          ...
          <p
            ...
            style={{ color: 'hsla(var(--text-secondary), 0.8)' }}
          >
            Natural gemstone beauty meets artisan craftsmanship.
          </p>
          <div className="flex flex-wrap justify-center gap-4 mb-8">
            <div
              className="flex items-center gap-2 px-4 py-2 rounded-full border shadow-sm text-sm"
              style={{
          ...
          <div className="flex gap-4 justify-center">
            <Link
              to="/products"
              className="px-6 py-3 rounded-full shadow-lg font-semibold"
              style={{
            ...
            <Link
              to="/about"
              className="border-2 px-6 py-3 rounded-full font-semibold"
              style={{
  ...
  classicDark: {
    ...
    commit: 'a3237fc',
    description:
      'Simple dark navy background with elegant gold accents. Clean and straightforward.',
    hero: (
      <section className="relative bg-slate-900 overflow-hidden min-h-[60vh] flex items-center">
        ...
        <div
          className="absolute w-2 h-2 bg-yellow-500 rounded-full top-1/2 left-1/3 animate-pulse"
          style={{ animationDelay: '0.5s' }}
        ></div>
        <div
          className="absolute w-2 h-2 bg-yellow-500 rounded-full bottom-10 right-10 animate-pulse"
        ...
        <div className="container mx-auto px-4 z-20">
          <div className="max-w-3xl">
            ...
            <p className="text-xl md:text-2xl text-gray-200 mb-8">
              Handcrafted crystal jewelry and artisan gemstone pieces in
              Winnipeg.
            </p>
            <div className="flex gap-4">
              <Link
              ...
              <Link
                to="/about"
                className="border-2 border-teal-500 text-teal-400 px-6 py-3 rounded-lg hover:bg-teal-900/30 transition-colors"
              >
  ...
  brandGradient: {
    ...
    commit: '72708db',
    description:
      'Deep gradient (turquoise → blue → gold) with floating gold accents and dark overlay.',
    hero: (
      <section className="relative overflow-hidden min-h-[60vh] flex items-center">
        <div
          ...
          style={{
            background:
              'linear-gradient(135deg, hsl(var(--bg-primary)) 0%, hsl(var(--bg-secondary)) 25%, hsl(var(--bg-tertiary)) 75%, hsl(var(--bg-tertiary)) 100%)',
          }}
        ></div>
        <div className="absolute w-4 h-4 bg-yellow-500 rounded-full top-10 left-10 animate-pulse"></div>
        <div
          className="absolute w-4 h-4 bg-yellow-500 rounded-full top-1/3 left-1/4 animate-pulse"
          style={{ animationDelay: '0.5s' }}
        ></div>
        <div
          className="absolute w-4 h-4 bg-yellow-500 rounded-full top-2/3 left-1/2 animate-pulse"
          style={{ animationDelay: '1s' }}
        ></div>
        ...
        <div className="container mx-auto px-4 z-20">
          <div className="max-w-3xl">
            ...
            <div className="flex gap-4">
              <Link
                to="/products"
                className="bg-yellow-500 text-slate-900 hover:bg-yellow-400 px-8 py-4 rounded-full font-semibold"
              >
                Browse our crystal jewelry
              </Link>
              <Link
                to="/about"
                className="border-2 border-yellow-500 text-yellow-400 hover:bg-yellow-500/10 px-8 py-4 rounded-full"
              >
                Learn more about our story
              </Link>
            </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-950">
      ...
      <div className="border-b border-slate-200 dark:border-slate-800 bg-white/50 dark:bg-slate-900/50 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 py-6">
          <Link
            to="/"
            className="text-teal-600 dark:text-teal-400 hover:underline mb-4 inline-block"
          >
            ← Back to Home
          </Link>
          ...
          <p className="text-slate-600 dark:text-slate-400">
            A visual journey through the evolution of Troves & Coves hero
            sections
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12 space-y-16">
        {(
          Object.entries(HeroVersions) as [
            string,
            (typeof HeroVersions)[keyof typeof HeroVersions],
          ][]
